...
export class AI {
	static PROB_WEIGHT = 5000; // arbitrarily big number
	...
	static OPENINGS = [
		{ 'x': 7, 'y': 3, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 6, 'y': 2, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 3, 'y': 7, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 2, 'y': 6, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 6, 'y': 6, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 3, 'y': 3, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 5, 'y': 5, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 4, 'y': 4, 'weight': getRandom(OPEN_LOW_MIN, OPEN_LOW_MAX) },
		{ 'x': 0, 'y': 8, 'weight': getRandom(OPEN_MED_MIN, OPEN_MED_MAX) },
		{ 'x': 1, 'y': 9, 'weight': getRandom(OPEN_HIGH_MIN, OPEN_HIGH_MAX) },
		{ 'x': 8, 'y': 0, 'weight': getRandom(OPEN_MED_MIN, OPEN_MED_MAX) },
		{ 'x': 9, 'y': 1, 'weight': getRandom(OPEN_HIGH_MIN, OPEN_HIGH_MAX) },
		{ 'x': 9, 'y': 9, 'weight': getRandom(OPEN_HIGH_MIN, OPEN_HIGH_MAX) },
		{ 'x': 0, 'y': 0, 'weight': getRandom(OPEN_HIGH_MIN, OPEN_HIGH_MAX) }
	];
